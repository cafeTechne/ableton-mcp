# Live.DrumChain Module Reference
...
| `choke_group` | list | Access to the chain’s choke group setting.... | R |
...
| `out_note` | list | Access to the MIDI note sent to the devices in the chain.... | R |
